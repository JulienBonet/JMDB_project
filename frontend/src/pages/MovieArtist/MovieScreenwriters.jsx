...
function MovieScreenwriters() {
  ...
  // --------------------------------------------
  useEffect(() => {
    getArtistsByLetter('screenwriters', selectedLetter)
  ...
  const fetchMoviesByScreenwriter = () => {
    getArtistMovies('screenwriters', selectedScreenW.id)
      .then((moviesData) => {
  ...
  const movieSortedA = async () => {
    try {
      const newData = await getArtistMoviesSorted('screenwriters', selectedScreenW.id, 0);
      setData(newData);
      setSortOrderA('asc');
    } catch (error) {
  ...
  const movieSortedZ = async () => {
    try {
      const newData = await getArtistMoviesSorted('screenwriters', selectedScreenW.id, 1);
      setData(newData);
      setSortOrderA('desc');
    } catch (error) {
      console.error('Error fetching data:', error);
  ...
  const movieSortedYear = async () => {
    try {
      const newData = await getArtistMoviesSorted('screenwriters', selectedScreenW.id, 2);
      setData(newData);
      setSortOrderY('asc');
    } catch (error) {
      console.error('Error fetching data:', error);
  ...
  const movieSortedYearDesc = async () => {
    try {
      const newData = await getArtistMoviesSorted('screenwriters', selectedScreenW.id, 3);
      setData(newData);
      setSortOrderY('desc');
    } catch (error) {
      console.error('Error fetching data:', error);
