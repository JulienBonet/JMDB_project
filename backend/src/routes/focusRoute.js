...
router.get('/focus/:id/movies/sorted0', focusController.getAllMoviesByCategoryIdAsc); // titre ASC
router.get('/focus/:id/movies/sorted1', focusController.getAllMoviesByCategoryIdDesc); // titre DESC
router.get('/focus/:id/movies/sorted2', focusController.getAllMoviesByCategoryIdYearAsc); // année ASC
router.get('/focus/:id/movies/sorted3', focusController.getAllMoviesByCategoryIdYearDesc); // année DESC
...
router.get('/focuscategory/byname/:name', focusController.getFocusCategoryByName);
