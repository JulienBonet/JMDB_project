...
router.get('/directors/focus/random', directorsController.getAllArtistFocusRandom);

router.get('/directors/focus/sorted/0', directorsController.getAllArtistFocusAsc);

router.get('/directors/focus/sorted/1', directorsController.getAllArtistFocusDesc);

router.get('/directors/focus/sorted/2', directorsController.getAllArtistFocusYearAsc);

router.get('/directors/focus/sorted/3', directorsController.getAllArtistFocusYearDesc);
