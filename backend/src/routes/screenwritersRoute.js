...
router.get('/screenwriters/sorted_id', screewritersController.getAllArtistIdDesc);
...
router.get('/screenwriters/sorted/:letter', screewritersController.getAllByLetter);
