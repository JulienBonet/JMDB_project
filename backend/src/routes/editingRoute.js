...
router.put('/director/:id/image', safeUpload, editingController.uploadDirectorImage);
...
router.put('/casting/:id/image', safeUpload, editingController.uploadCastingImage);
...
router.put('/screenwriter/:id/image', safeUpload, editingController.uploadScreenwriterImage);
...
router.put('/compositor/:id/image', safeUpload, editingController.uploadCompositorImage);
...
router.put('/studio/:id/image', safeUpload, editingController.uploadStudioImage);
...
router.put('/country/:id/image', safeUpload, editingController.uploadCountryImage);
