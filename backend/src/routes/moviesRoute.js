...
router.get('/movies/search-filter', authOptional, moviesController.getFilteredMovies);
...
router.get('/movies/sorted/country/sorted/0/:id', moviesController.getAllByCountrySorted0);
router.get('/movies/sorted/country/sorted/1/:id', moviesController.getAllByCountrySorted1);
router.get('/movies/sorted/country/sorted/2/:id', moviesController.getAllByCountrySorted2);
router.get('/movies/sorted/country/sorted/3/:id', moviesController.getAllByCountrySorted3);
