...
router.put('/movie/:id/image', upload.single('cover'), editingMovieController.editMovieImage);

// --- Update affiche depuis URL ---
router.put('/movie/:id/image-from-url', editingMovieController.updateImageFromUrl);
