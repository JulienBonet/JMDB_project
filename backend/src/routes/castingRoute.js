...
router.get('/casting/focus/sorted/2', castingController.getAllArtistFocusYearAsc);

router.get('/casting/focus/sorted/3', castingController.getAllArtistFocusYearDesc);
